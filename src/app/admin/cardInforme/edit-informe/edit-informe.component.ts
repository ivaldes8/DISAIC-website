...
export class EditInformeComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.editCardForm.controls['isPublic'].setValue(this.isPublic);

    if(this.edit == "informe"){
      this.url = "informeUpdate"
    }
  }
  ...
  onEditFormSubmit() {
    ...
    this.obj.append('isPublic',this.editCardForm.controls.isPublic.value);
