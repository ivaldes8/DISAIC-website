export const environment = {
  production: true,
  API_DISAIC_URL: 'https://www.disaic.ivan/api/api',
  API_DISAIC_IMG_URL: 'https://www.disaic.ivan/storage/images',
  API_DISAIC_PDF_URL: 'https://www.disaic.ivan/storage/pfs',
